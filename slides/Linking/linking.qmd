...
## Übung
Gehe zu []() und Löse die Aufgaben zur Datenaufbereitung und zum Linking. 



## Zurück zum Anfang: Differential Item Functioning 

- Wir haben jetzt gesehen, wie man Item- und Personenparamter aus verschiedenen Kalibrierungen auf die selbe Skala bringen kann. 
- Jetzt können wir uns also noch einmal mit dem Eingangsproblem dieser Session beschäftigen: Differential Item Functioning. 


## DIF finden

Es gibt viele verschiedene Verfahren, mit denen man Items auf DIF tests kann. 
Die Grundidee ist folgende: Wir schauen, ob Items in bestimmten Gruppen häufiger beantwortet wurden als in anderen Gruppen, bzw. ob die Itemparamter in bestimmten Gruppen anders geschätzt wurden (nachdem gelinkt wurde).  
