...
:::{.callout-note}
Die logit Funktion bringt also unsere Werte auf die logit-Skala, sodass sie zwischen 0 und 1 liegen.
:::
...
[Nehmen wir unsere Schulen und Schüler*innen nun also [random]{.highlight} oder [fixed]{.highlight} effects ins Modell auf?]{.highlight}
