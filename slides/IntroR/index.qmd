...
title-slide-attributes:
  data-background-image: ./images/r_icon.png
...
# https://www.pinterest.de/pin/842384305333412119/

library(aRtsy)

set.seed(43)
canvas_collatz(colors = c("#3d528f", "#DEE1E1", "#561a26", "#cfbbab", "#A4B5D0"))
...
## 3) Workspace {background-image="images/artwork.png" background-size="400px"}
...
::: {.absolute left="5%" bottom="5%" style="font-size:2em; padding: 0.5em 0.5em; background-color: rgba(255, 255, 255, .7); backdrop-filter: blur(5px); box-shadow: 0 0 1rem 0 rgba(255, 255, 255 .5); border-radius: 5px;"}
...
## `tidyverse` {style="text-align: right;"}
:::: {.columns} 

::: {.column width="50%"}
![](./images/tidyverse_logo.png){.image-left}
:::
::: {.column width="50%"}
- Das [`tidyverse`](https://www.tidyverse.org/) ist eine verbreitete Paketsammlung in R. 
