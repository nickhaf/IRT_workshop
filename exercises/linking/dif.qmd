...
Ziel dieser Übung ist es, die grundlegendes Linking in R auszuprobieren, und eine erste Differential Item Functioning (DIF) Analyse durchzuführen. 
...
# 2. Linking
Wir haben gleich vor, DIF auf der Geschlecht-Variable zu untersuchen. 

## 2.1 GruppenAls erstes 
...
```{r}
table(qa_dat_wide$bundeslandStudium)
```
